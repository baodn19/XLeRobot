...
class XLerobotConfig(RobotConfig):
    ...
    port_right_head: str = "/dev/ttyACM0"  # port to connect to the bus (so101 + head camera)
    port_left_base: str = "/dev/ttyACM1"  # port to connect to the bus (same as lekiwi setup)
